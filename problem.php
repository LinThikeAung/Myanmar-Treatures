...
<div class="container-fluid">
      <br><br>
            ...
            $summary_post=$object1->Select_Summary("tasks",$trend_id);
             ...
             ?>
                ...
                <div class="col-lg-7">
                  ...
                  <br><br>
                  <p class="zawgyi unicode"><?php echo $summary_posts['summary'] ?><br>
                  <!-- <video width="500px" height="400px" controls class="btn-link"><source src="trend_video/<?php echo $summary_posts['video'] ?>" type="video/webm"></video> -->
            ...
            <?php
            $id=$_GET['trend_id'];
            $allposts=$object1->Problem_Posts("problem_post_list",$id);
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-body" style="background-image: -webkit-linear-gradient(0deg, #e66587 0%, #f09458 100%);">
                        ...
                        <p class="card-text zawgyi unicode text-white">
                        <?php  echo substr($description,0,700);
                                echo strlen($description)>700 ? '. . . . .': ''; ?>
                        <a href="readmore_trend.php?trend_id=<?php echo $_GET['trend_id'] ?> &post_id=<?php echo $post_id ?>" class="text-dark">read more</a></p>  
                        <div class="row">
