          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card-header card-header-info card-header-icon">
                  <div class="card-icon">
                      <i class="fa fa-tasks zawgyi unicode"></i> Problems In Myanmar
                  </div>
                <div class="card-body">
                <br><br>
                  <form method="post" enctype="multipart/form-data" class="zawgyi unicode">
                            ...
                            <div class="fileinput fileinput-new text-left" data-provides="fileinput">
                                    ...
                                    <div>
                                        <span class="btn btn-raised btn-round btn-default btn-file">
                                            <span class="fileinput-new">Select Trending </span>
                    ...
                    <div class="form-group">
                          <input type="submit" class="btn btn-info pull-left" name="important"  value="Add">
